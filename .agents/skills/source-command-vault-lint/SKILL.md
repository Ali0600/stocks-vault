---
name: "source-command-vault-lint"
description: "Lint the vault — contradictions, stale speculations, orphan articles, index drift"
---

# source-command-vault-lint

Use this skill when the user asks to run the migrated source command `vault-lint`.
...
Fix `index.md` drift directly (it is Codex-maintained). For anything that touches
